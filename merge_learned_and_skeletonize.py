...
def main():
    in_learned_skeletons_path = "dataset/point/learned_skeletons"
    ...
    for learned_img, skeletonize_img, skeletonize_lee_img, medial_axis_skeleton_img, thinned_skeleton_img in zip(os.listdir(in_learned_skeletons_path), os.listdir(in_skeletonize_path), os.listdir(in_skeletonize_lee_path), os.listdir(in_medial_axis_skeletons_path), os.listdir(in_thinned_skeletons_path)):
        print(learned_img)
        ...
        for i in range (256):
            for j in range(256):
                merged_img_immat[(i, j)] = l_img_immat[(i, j)] + s_img_immat[(i, j)] + sl_img_immat[(i, j)]
